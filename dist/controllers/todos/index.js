...
var updateTodo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, updatedTodo, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, todo_1.default.findByIdAndUpdate({ _id: id }, req.body)];
            case 1:
                updatedTodo = _a.sent();
...
var deleteTodo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, deletedTodo, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, todo_1.default.findByIdAndRemove(id)];
            case 1:
                deletedTodo = _a.sent();
